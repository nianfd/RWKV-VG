...
from utils.box_utils import bbox_iou, xywh2xyxy, xyxy2xywh, generalized_box_iou, balanced_l1_loss
...
def trans_vg_loss(batch_pred, batch_target):
    ...
    # ))
    #loss_bbox = balanced_l1_loss(batch_pred, batch_target)
    loss_giou = generalized_box_iou(xywh2xyxy(batch_pred),xywh2xyxy(batch_target))
